...
describe('application bulk delete contracts', () => {
  ...
  it('reads applications from workspace state and refreshes persisted rows on visit', () => {
    ...
    expect(applicationsPage).toMatch(/applicationsVisibleOnApplicationsPage/)
    expect(applicationsPage).toMatch(/View JD/)
    expect(applicationsPage).toMatch(/View Resume/)
    expect(applicationsPage).toMatch(/Open Application/)
    expect(applicationsPage).toMatch(/submittedJobDescriptionSnapshot/)
    expect(applicationsPage).toMatch(/selectedResumeVersionId/)
    expect(applicationsPage).toMatch(/applicationUrl/)
    ...
    expect(workspace).toMatch(/applicationStatus !== 'submitted'/)
